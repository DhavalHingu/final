...
<tr>
	...
	<?php
       ...
       while($rs=mysql_fetch_array($sql))
       {
          ...
          echo'<option value="'.$rs['block_no'].'">'.$rs['block_name'].'</option>';
       }
      }
...
<tr><td colspan="2">
<button type="submit"  name="action" value="insert">ADD</button></td></tr></table>
</form>
