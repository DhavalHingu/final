...
<tr>
	<td>Student Name</td>
	<td><select name="email_id" required="required">
	<option value="-">Select Student Name</option>
	<?php
				                       
       $sql=mysql_query("SELECT * FROM regestration_form where status='1'");
...
<tr>
	...
	<option value="onlyhostel">Hostel Fees</option>
	<option value="hostelwithmess">Hostel + Mess Fees</option>
	</select>
	</td>
</tr>
<tr><td>Total Fees</td><td><input type="text" name="total_fees" value="" required="required"></td></tr>
<tr><td>Date</td><td><input type="date" name="date" value="" required="required"></td></tr>
<tr><td colspan="2">
<button type="submit"  name="action" value="insert">Submit</button></td></tr></table>
</form>
