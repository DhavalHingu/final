...
<li><a class="drop" href="#">reports</a>
    ...
    <center><h1>Hostel + Mess Fees Report<a href="../controller/reportController.php?action=hostel_mess_fees"  title="Download Excel" style="font-size: 15px;color: red;">(Download Excel)</a></h1></center>
