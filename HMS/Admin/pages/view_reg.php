...
<?php
	...
	<tr>
		...
		<td><a href="../controller/confirm_regController.php?action=confirm&email_id=<?php echo $email_id;?>"  title="Confirm" >Confirm</a></td>
	</tr>
		<?php } ?>
...
<center><h1>Confirm Registration <a href="../controller/confirm_regController.php?action=dow_excel"  title="(Download Excel)" style="font-size: 15px;color: red;">(Download Excel)</a></h1></center>
